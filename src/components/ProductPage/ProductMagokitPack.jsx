...
import Magokits_product from "../../img/Magobox-mini-Fullset.png";
        ...
        <div className="container">
          ...
          <div className="product-info">
            <div className="product-img">
              <img src={Magokits_product} alt="Magokits product" />
            </div>
...
export default ProductMagokits;
