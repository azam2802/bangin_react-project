...
import wasteBin from "../../img/Section4_card-img6.png";
        ...
        <div className="container">
          ...
          <div className="product-info">
            <div className="product-img">
              <img src={wasteBin} alt="Waste Bin 2in1" />
            </div>
            <div className="product-text">
              <h3>Product</h3>
              <h1>Waste Bin 2in1</h1>
              <h6>
...
export default ProductWasteBin;
