...
import composingTools from "../../img/Section4_card-img2.png";
        ...
        <div className="container">
          ...
          <div className="product-info">
            <div className="product-img">
              <img src={composingTools} alt="Composing Tools" />
            </div>
            <div className="product-text">
              <h3>Product</h3>
              <h1>Composing Tools</h1>
              <h6>
...
export default ProductComposing;
